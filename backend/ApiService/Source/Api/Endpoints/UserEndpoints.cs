    ...
    public static class UserEndpoints
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return result.ErrorCode switch
            {
                ...
                "DeleteFailed" => Results.Problem(detail: result.ErrorMessage, statusCode: StatusCodes.Status500InternalServerError),
                _ => Results.Problem(detail: "Unknown error.", statusCode: StatusCodes.Status500InternalServerError)
            };
        }
    }
}